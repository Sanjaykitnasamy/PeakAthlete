...
var min = parseInt(sec/120)   //get minutes
...
function submitQuiz() {
  ...
  if (getRadioValue('q1') === -1) {
    ...
    document.getElementById('correctAnswer1').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer1').innerHTML = correct(1);
    document.getElementById('correctAnswer1').style.backgroundColor="#004d00"
  }
  if (getRadioValue('q2') === -1) {
    document.getElementById('correctAnswer2').innerHTML = correctAnswer('correctString2', 2);
    document.getElementById('correctAnswer2').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer2').innerHTML = correct(2);
    document.getElementById('correctAnswer2').style.backgroundColor="#004d00"
  }
  if (getRadioValue('q3') === -1) {
    document.getElementById('correctAnswer3').innerHTML = correctAnswer('correctString3', 3);
    document.getElementById('correctAnswer3').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer3').innerHTML = correct(3);
    document.getElementById('correctAnswer3').style.backgroundColor="#004d00"
  }
  if (getRadioValue('q4') === -1) {
    document.getElementById('correctAnswer4').innerHTML = correctAnswer('correctString4', 4);
    document.getElementById('correctAnswer4').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer4').innerHTML = correct(4);
    document.getElementById('correctAnswer4').style.backgroundColor="#004d00"
  }
  if(getRadioValue('q5') === -1){
    document.getElementById('correctAnswer5').innerHTML = correctAnswer('correctString5', 5);
    document.getElementById('correctAnswer5').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer5').innerHTML = correct(5);
    document.getElementById('correctAnswer5').style.backgroundColor="#004d00"
  }
  if(getRadioValue('q6') === -1){
    document.getElementById('correctAnswer6').innerHTML = correctAnswer('correctString6', 6);
    document.getElementById('correctAnswer6').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer6').innerHTML = correct(6);
    document.getElementById('correctAnswer6').style.backgroundColor="#004d00"
  }
  if(getRadioValue('q7') === -1){
    document.getElementById('correctAnswer7').innerHTML = correctAnswer('correctString7', 7);
    document.getElementById('correctAnswer7').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer7').innerHTML = correct(7);
    document.getElementById('correctAnswer7').style.backgroundColor="#004d00"
  }
  if(getRadioValue('q8') === -1){
    document.getElementById('correctAnswer8').innerHTML = correctAnswer('correctString8', 8);
    document.getElementById('correctAnswer8').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer8').innerHTML = correct(8);
    document.getElementById('correctAnswer8').style.backgroundColor="#004d00"
  }
  if(getRadioValue('q9') === -1){
    document.getElementById('correctAnswer9').innerHTML = correctAnswer('correctString9', 9);
    document.getElementById('correctAnswer9').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer9').innerHTML = correct(9);
    document.getElementById('correctAnswer9').style.backgroundColor="#004d00"
  }
  if(getRadioValue('q10') === -1){
    document.getElementById('correctAnswer10').innerHTML = correctAnswer('correctString10', 10);
    document.getElementById('correctAnswer10').style.backgroundColor="#cc3300"
  }else{
    document.getElementById('correctAnswer10').innerHTML = correct(10);
    document.getElementById('correctAnswer10').style.backgroundColor="#004d00"
  }
  ...
  if(score>10){
    document.getElementById("showAnswer").style.backgroundColor="none"
  }else{
    document.getElementById("showAnswer").style.backgroundColor="none"
  }
}